...
class ConversionArguments:
    ...
    optimize: str = field(
        ...
        metadata={
            "help": (
                "Allows to run ONNX Runtime optimizations directly during the export. Some of these optimizations are specific"
                "to ONNX Runtime, and the resulting ONNX will not be usable with other runtime as OpenVINO or TensorRT."
